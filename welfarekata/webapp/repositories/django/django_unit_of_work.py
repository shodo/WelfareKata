...
from welfarekata.webapp.repositories.django.django_product_repository import DjangoProductRepository
from welfarekata.webapp.repositories.django.django_purchase_repository import DjangoPurchaseRepository
