...
from welfarekata.webapp.repositories.purchase_repository import PurchaseRepository
...
class TestPurchaseRepository(TestCase):
    ...
    def test_add(self):
        ...
        # SUT
        added_purchase = PurchaseRepository.add(purchase)
    ...
    def test_get(self):
        ...
        # SUT
        retrieved_purchase = PurchaseRepository.get(orm_purchase.external_id)
    ...
    def test_list(self):
        ...
        # SUT
        retrieved_purchases = PurchaseRepository.list()
