...
from welfarekata.webapp.repositories.account_repository import AccountRepository
...
class TestAccountRepository(TestCase):
    def test_add(self):
        ...
        # SUT
        added_account = AccountRepository.add(account)
    ...
    def test_get(self):
        ...
        # SUT
        retrieved_account = AccountRepository.get(orm_account.external_id)
        retrieved_account_for_update = AccountRepository.get(orm_account.external_id, for_update=True)
    ...
    def test_list(self):
        ...
        # SUT
        retrieved_accounts = AccountRepository.list()
    ...
    def test_update(self):
        ...
        updated_account = AccountRepository.update(new_account)
