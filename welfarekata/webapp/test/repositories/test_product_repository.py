...
from welfarekata.webapp.repositories.product_repository import ProductRepository
...
class TestProductRepository(TestCase):
    def test_add(self):
        ...
        # SUT
        added_product = ProductRepository.add(product)
    ...
    def test_get(self):
        ...
        # SUT
        retrieved_product = ProductRepository.get(orm_product.external_id)
    ...
    def test_list(self):
        ...
        # SUT
        retrieved_products = ProductRepository.list()
    ...
    def test_update(self):
        ...
        updated_product = ProductRepository.update(new_product)
